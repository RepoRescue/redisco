...
class ModelTestCase(RediscoTestCase):
    ...
    def test_repr(self):
        person1 = Person(first_name="Granny", last_name="Goose")
        # Python 3.7+ dict order is insertion order, not alphabetical
        self.assertIn("'first_name': 'Granny'", repr(person1))
        self.assertIn("'last_name': 'Goose'", repr(person1))
        self.assertIn("'active': False", repr(person1))
        ...
        self.assertIn("'last_name': 'Goose'", repr(person1))
        self.assertIn("'active': False", repr(person1))
        self.assertIn("'id': '1'", repr(person1))
